...
var _ servicer.Servicer = new(CreateDashboardInput)

func (input *CreateDashboardInput) CheckParams(ctx *gin.Context) error {
	if input.RegionId <= 0 {
...
func (input *CreateDashboardInput) BuildOutput(ctx *gin.Context) (interface{}, error) {
	input.StoredId = 1
