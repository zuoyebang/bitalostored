...
import (
	...
	"github.com/zuoyebang/bitalostored/raft/internal/tests"
	"github.com/zuoyebang/bitalostored/raft/internal/tests/kvpb"
	"github.com/zuoyebang/bitalostored/raft/internal/utils/dio"
...
func (p *testNodeProxy) DoSnapshotForMemberships() {}
...
func testHandleBatchedSnappyEncodedEntry(t *testing.T,
	...
	if err := tsm.handleBatch(entries, batch, tsm.lastApplied.index); err != nil {
		t.Fatalf("handle failed %v", err)
	}
...
func (t *testManagedStateMachine) Open() (uint64, uint64, error) { return 10, 10, nil }
...
func TestHandleBatchedEntriesForOnDiskSM(t *testing.T) {
	...
	for idx, tt := range tests {
		...
		if err := sm.handleBatch(input, ents, sm.lastApplied.index); err != nil {
...
func (e *errorNodeProxy) DoSnapshotForMemberships()   {}
