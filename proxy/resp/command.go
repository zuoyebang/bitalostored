...
const (
	...
	DK_CREATE      string = "DK.CREATE"
	DK_CREATESHARD string = "DK.CREATESHARD"
	DK_INFO        string = "DK.INFO"
	DK_INCRBYSIZE  string = "DK.INCRBYSIZE"

	DK_EXISTS  string = "DK.EXISTS"
	DK_DEL     string = "DK.DEL"
	DK_HCREATE string = "DK.HCREATE"
	DK_HSET    string = "DK.HSET"
	DK_HINCRBY string = "DK.HINCRBY"
	DK_HGET    string = "DK.HGET"
	DK_HMGET   string = "DK.HMGET"
	DK_HDEL    string = "DK.HDEL"
	DK_HLEN    string = "DK.HLEN"
	DK_HEXISTS string = "DK.HEXISTS"

	DK_SCREATE   string = "DK.SCREATE"
	DK_SADD      string = "DK.SADD"
	DK_SREM      string = "DK.SREM"
	DK_SPOP      string = "DK.SPOP"
	DK_SCARD     string = "DK.SCARD"
	DK_SISMEMBER string = "DK.SISMEMBER"
)
